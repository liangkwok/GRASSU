<?php
require_once ( "./Baidu-Push-SDK-Php-2.0.4-advanced/Channel.class.php" ) ;

//请开发者设置自己的apiKey与secretKey
$apiKey = "L1q0V4VBUS3RnoMIFXy5Uqdk";
$secretKey = "UZor3AOFWGPMxEMGlh96RNdydcGaeRi2";
test_pushMessage_ios('1074386561197704893');
test_pushMessage_ios('595926028594133711');
test_pushMessage_android('1094193118399339803');
